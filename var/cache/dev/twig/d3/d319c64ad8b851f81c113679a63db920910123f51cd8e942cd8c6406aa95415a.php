...
class __TwigTemplate_67e29deb0c371029881d780e7cf01be605fe978ddc06d21ac1cfed1e507151ab extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 1, $this->source); })()), "id", [], "any", false, false, false, 1)]), "html", null, true);
        echo "\" onsubmit=\"return confirm('Vous êtes sur de vouloir effacer ?');\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('admin_delete', {'id': post.id}) }}\" onsubmit=\"return confirm('Vous êtes sur de vouloir effacer ?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ post.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "admin/_delete_form.html.twig", "C:\\Users\\PC\\PhpstormProjects\\fidlelyTest\\la-boutique-francaise\\templates\\admin\\_delete_form.html.twig");
    }
}

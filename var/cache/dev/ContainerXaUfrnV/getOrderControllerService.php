...
class getOrderControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.iRkeTRL'] ?? $container->load('get_ServiceLocator_IRkeTRLService'))->withContext('App\\Controller\\OrderController', $container));
